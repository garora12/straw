...
@Component({
  selector: 'app-voted-polls-listing',
  templateUrl: './voted-polls-listing.component.html',
  styleUrls: ['./voted-polls-listing.component.css']
})
export class VotedPollsListingComponent implements OnInit {
  ...
  next() {
    ...
    if( this.currentPage <= this.totalPages ) {
      ...
      this.getVotedPollListing( offset );
    } else {
      this.currentPage--;  
    }
  }
  ...
  search( e ) {
    ...
    this.getVotedPollListing( this.offset );
  }

  getVotedPollListing( offset ) {
    ...
    this.pollService.getVotedPollListing( this.in_data ).subscribe(
      result => {
        this.spinner.hide();
